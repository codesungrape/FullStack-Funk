...
export async function POST(request: Request) {
   ...
   try {
    ...
    const completion = await openAI.chat.completions.create({
        model: "gpt-4-turbo",
        messages: [
            { role: "system", content: "You are a creative songwriter specializing in educational content. You have won many grammys and awards so you are very great at what you do." },
